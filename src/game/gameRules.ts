...
export const computeScore = (currentFrame: CurrentFrame, knockedPinsCount: number, previousFrameResult: FrameResult, framesScore: any, onUpdateFramesScore: any): void => {
  ...
  if (currentFrame.frameNumber > 1) {
    ...
    bonusPoint = computePreviousFrameBonusPoint(previousFrameResult.resultType, currentFrame, knockedPinsCount);
    // TODO find a better way to update object in array
